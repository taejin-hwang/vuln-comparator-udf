...
==================
  ...
  * browser: build
  * tests: refactor some tests to support new objDisplay compare
  ...
  * util: [objDisplay] normalize compare of functions
...
==================
  ...
  * code clean
  * prefix/suffix to wrap browser compare to prevent conflicts with other `require` methods.
